...
def fashionMnist(noTrSamples=1000, noValSamples = 400,noTsSamples=100, \
                        digit_range=['T-shirt/top','Trouser', 'Pullover', 'Dress','Coat','Sandal','Shirt','Sneaker','Bag','Ankle boot'], \
